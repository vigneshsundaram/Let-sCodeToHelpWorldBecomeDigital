...
public class Main {
	...
	public static void main(String[] args) throws SlotNotOccupied {
		...
		try {
			...
			System.out.println(parkingManager.parkVehicle(vehicle,"2"));
			vehicle = new Vehicle("TN38BJ8509", VehicleType.FOURWHELLER);
			System.out.println(parkingManager.parkVehicle(vehicle,"1"));
			
			System.out.println(parkingManager.getSlotDetailFromVehicleNumber("TN38BJ8509"));
			parkingManager.freeSlot("3");
			System.out.println(parkingManager.getSlotStatus("1"));
			System.out.println(parkingManager.getSlotStatus("2"));
			System.out.println(parkingManager.getSlotStatus("3"));
			System.out.println(parkingManager.getSlotStatus("4"));
			System.out.println(parkingManager.getSlotStatus("5"));
			System.out.println(parkingManager.getSlotStatus("6"));
			parkingManager.freeSlot("6");
			System.out.println(parkingManager.getSlotStatus("6"));
			System.out.println(parkingManager.getSlotStatus("7"));
			System.out.println(parkingManager.getSlotStatus("8"));
			System.out.println(parkingManager.getSlotStatus("9"));
			parkingManager.freeSlot("6");
			System.out.println(parkingManager.getSlotStatus("10"));
			System.out.println(parkingManager.getSlotStatus("11"));
			System.out.println(parkingManager.getSlotStatus("12"));

		} catch (invalidSlotType | SlotNotAvailable | SlotOccupied e) {
